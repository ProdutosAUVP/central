...
export const novidadesMensais: NovidadeMensal[] = [
  {
    ...
    items: [
      ...
      { emoji: "📌", titulo: "ETFs Irlandeses disponíveis na nossa plataforma", corpo: "Os tão pedidos ETFs Irlandeses (UCITS) já estão liberados para todos que possuem conta internacional da AUVP. Basta garantir que o aplicativo BTG Investimentos esteja atualizado para a versão mais recente." },
  ...
  },
  {
    ...
    items: [
      { emoji: "🦁", titulo: "Atualizações no Módulo de Imposto de Renda", corpo: "O radar da Receita mudou alguns pontos em 2026. O módulo bônus de IR da AUVP Escola já está com todas as novas obrigatoriedades detalhadas, tudo para você não cair nas garras do Leão!" },
      { emoji: "🪙", titulo: "Novo Módulo Bônus: Criptomoedas", corpo: "Liberamos um novo módulo com um dos conteúdos mais solicitados por vocês: criptomoedas. São 15 aulas explicando do zero sobre essa modalidade, de forma didática e alinhada com a filosofia buy and hold." },
      ...
      { emoji: "🔧", titulo: "Melhorias técnicas no Hub de Produtos", corpo: "Realizamos melhorias técnicas e corrigimos bugs que atrapalhavam sua experiência no Hub AUVP, para garantir que sua navegação seja cada vez mais fluida e intuitiva." },
      { emoji: "📊", titulo: "Visualização em tabela para análise de ativos na Analítica (exclusivo para assinantes)", corpo: "Nova funcionalidade para comparar ativos de forma prática. Agora você visualiza tudo de uma vez e ordena pelas colunas que mais importam para sua estratégia. Menos cliques, mais clareza." },
      { emoji: "🟢", titulo: "Convocação AUVP — Camisa BR x AUVP", corpo: "Lançamos a campanha para quem quer vestir o orgulho da nossa comunidade. Para ganhar sua camiseta vintage exclusiva: débito automático ativo, streaming mensal ativo, Open Finance com 80% do patrimônio e inscrição na campanha." },
    ],
  ...
  },
  {
    ...
    items: [
      { emoji: "📌", titulo: "Atualização de módulo 6: nova aula 6.5 sobre REITs", corpo: "O módulo 6 já possui 6 aulas atualizadas, da 6.1 a 6.4 (dividida em três partes). A nova 6.5 explica todas as pormenoridades dos REITs para te dar um panorama completo sobre o investimento internacional." },
      { emoji: "📝", titulo: "Novas aulas no Módulo de Análise de Setores (exclusivo AUVP Sempre)", corpo: "Liberamos 12 aulas novas no Módulo de Análise de Setores. Para além do setor Bancário, você vai dominar: Mineração, Energia Elétrica, Petróleo, Saneamento, Proteína Animal e muito mais." },
      ...
      { emoji: "📊", titulo: "Análise dos Resultados mensais de FIIs com IA na AUVP Analítica (exclusivo para assinantes)", corpo: "Nova funcionalidade para facilitar o acompanhamento do desempenho mensal de Fundos Imobiliários. Os assinantes têm acesso a análises especialmente desenvolvidas com IA." },
      ...
      { emoji: "🧠", titulo: "Convocação aberta para construirmos o SUPER APP da AUVP", corpo: "Abrimos a primeira chamada para selecionar Designers UX/UI e Desenvolvedores para nos ajudarem a construir de forma colaborativa o Super APP da AUVP." },
      { emoji: "🎥", titulo: "Estreia do Giro da Bolsa Itinerante (sem censura) em BH", corpo: "A primeira edição em Belo Horizonte foi INCRÍVEL. Tivemos gravação ao vivo do Giro + um momento de troca e Baguncinha presencial com os membros. 📢 Próximo destino em breve — os ingressos esgotam RÁPIDO!" },
    ],
  ...
  },
  {
    ...
    items: [
      { emoji: "💷", titulo: "Atualização no módulo 6: 3 novas aulas sobre ETFs internacionais", corpo: "Dividimos a aula em 3 partes para te dar um panorama completo. Exploramos como esses fundos podem ser uma das formas mais simples de acessar o mercado internacional, incluindo ações, renda fixa, REITs e commodities." },
      ...
      { emoji: "🔴", titulo: "Aula extra no módulo 4: armadilhas do mercado — produtos financeiros ruins", corpo: "COE, opções… Raul mostra como identificar produtos que parecem bons mas travam seus rendimentos por trás de conflitos de interesse. Investir com autonomia também é saber dizer não ao que brilha mas não gera valor." },
      { emoji: "📉", titulo: "Aula extra no módulo 5: os ciclos estranhos do Bitcoin", corpo: "Raul explica o que realmente sustenta o preço do Bitcoin: a combinação entre escassez e utilidade da descentralização. Entenda por que uma posição pequena (1% a 5%) pode equilibrar risco e oportunidade no longo prazo." },
      { emoji: "🗺️", titulo: "Módulo de geopolítica: Índia (exclusivo AUVP Sempre)", corpo: "3 aulas completas sobre como a Índia está se posicionando no cenário global, seu crescimento como potência emergente e as relações estratégicas que moldam sua influência internacional." },
      { emoji: "🖥️", titulo: "Novo menu da AUVP em fase de testes", corpo: "Estamos testando um menu que unifica o acesso para diferentes links da AUVP — Hub, comunidade, analítica… Vamos subir o novo menu gradualmente em todas as nossas plataformas." },
    ],
  ...
  },
  {
    ...
    items: [
      { emoji: "📌", titulo: "Atualização de módulo: nova aula 6.3 já está disponível", corpo: "O módulo 6 já possui 3 aulas atualizadas, da 6.1 a 6.3! A 6.3 conta com um panorama geral sobre a diferença do mercado americano em comparação com o brasileiro. Em fevereiro, mais atualizações." },
      { emoji: "📈", titulo: "ETFs: dúvidas que vocês sempre pediram", corpo: "O Raul gravou duas aulas novas e bem completas, explicando em cada detalhe o AUPO11 e o AREA11. Essas aulas já estão no ar, no Módulo 3, logo depois das explicações sobre Tesouro Direto e Juros Semestrais." },
      ...
      { emoji: "🌍", titulo: "Módulos de Geopolítica (exclusivo AUVP Sempre)", corpo: "Panoramas completos das maiores potências mundiais, explicados por especialistas.", subitems: ["Módulo EUA: todas as aulas no ar, por Carlos Stuart (Mestre em Direito Econômico) ✅", "Módulo China: aulas atualizadas com slides novos ✅", "Módulo Índia: novas aulas em edição — em breve"] },
